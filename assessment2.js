...
const totalResultInterpretations = {
    excellent: "Você demonstra um desempenho excepcional em todas as áreas do networking. A combinação de suas habilidades de agradabilidade, expertise, confiança, colaboração e visibilidade demonstra um nível atual altíssimo de Magnetismo Pessoal de Networking. Sua capacidade de construir relacionamentos sólidos, comunicar seus conhecimentos e promover suas conquistas reflete um alto “valuation” pessoal e profissional. Continue investindo no aprimoramento contínuo para manter e expandir essa excelência, pois seu magnetismo pessoal é um diferencial competitivo poderoso. Você pode acessar materiais de aprofundamento no site www.innernetworking.com.br.",
      good: "Seu índice indica que você possui boas habilidades de networking e já alcançou uma base sólida em diversas dimensões do seu Magnetismo Pessoal de Networking. No entanto, existem oportunidades de aprimoramento em alguns atributos para que você atinja um nível ainda mais elevado. Analise quais dimensões tiveram pontuações mais baixas e concentre seus esforços em desenvolver essas áreas por meio de conteúdos, treinamentos, feedbacks e práticas direcionadas. Você pode acessar esses materiais de aprofundamento no site www.innernetworking.com.br.",
	average: "Sua pontuação média em seu Nível de Magnetismo Pessoal sugere que, embora você apresente competências em networking, há desafios importantes a serem superados. Identifique os atributos em que seu desempenho é menos consistente e busque estratégias práticas (como mentorias, cursos ou mudanças de comportamento e novos hábitos) para aprimorar sua atuação. Investir no desenvolvimento dessas habilidades permirá transformar seus relacionamentos profissionais e ampliar suas oportunidades. Você pode acessar esses materiais de aprofundamento no site www.innernetworking.com.br.",
	bad: "Seu índice aponta para desafios significativos no desenvolvimento das habilidades de networking. É essencial trabalhar de forma consistente e direcionada em todas as dimensões – desde a receptividade e colaboração até a visibilidade e demonstração de resultados. Procure treinamentos, mentorias, leituras e práticas que estimulem seu crescimento pessoal e profissional, a fim de fortalecer suas conexões e expandir seu magnetismo no ambiente de trabalho. Você pode acessar esses materiais de aprofundamento no site www.innernetworking.com.br."
...
const sectionInterpretations = {
  "1. AGRADABILIDADE": {
    excellent:
      "Você demonstra uma alta capacidade de ser receptivo(a), cordial e empático(a) em suas interações, estabelecendo vínculos com facilidade e criando um ambiente de relacionamento positivo. Ações recomendadas: Mantenha seu comportamento receptivo, diversifique suas interações, lidere conversas construtivas e continue cultivando relacionamentos.",
    good:
      "Suas habilidades interpessoais são sólidas, embora haja pequenas variações na consistência da sua receptividade e atenção. Ações recomendadas: Procure aprimorar a escuta ativa e mantenha a abertura em todas as interações, reforçando a consistência no contato com diferentes perfis.",
    average:
      "Você apresenta desafios em manter uma postura consistentemente receptiva e atenta, o que pode afetar a qualidade dos vínculos. Ações recomendadas: Invista em treinamentos de comunicação, participe de eventos de networking e pratique técnicas de empatia e escuta ativa para fortalecer suas relações.",
    bad:
      "Sua pontuação indica dificuldade significativa em demonstrar receptividade e estabelecer vínculos positivos, prejudicando seu networking. Ações recomendadas: Busque conteúdos, workshops e mentorias focadas em comunicação eficaz e relacionamento interpessoal, e esforce-se para interagir com pessoas fora do seu círculo habitual, adotando novos hábitos de vida. Para saber mais sobre a agradabilidade e o IMP (Índice de Magnetismo Pessoal), você pode acessar os materiais de aprofundamento gratuitos no site www.innernetworking.com.br. Além disso, caso seja do seu interesse, você pode obter uma versão detalhada do seu IMP e mesmo desenvolver o seu Desafio Perfeito para dar um salto evolutivo em seu nível de networking.",
  },
  "2. EXPERTISE": {
    excellent:
      "Você utiliza suas competências de forma consistente para inovar, atingir metas e superar desafios, mantendo-se sempre atualizado(a) e compartilhando conhecimentos de maneira estratégica. Ações recomendadas: Continue investindo em sua atualização e compartilhe seus aprendizados para consolidar sua reputação profissional.",
    good:
      "Suas habilidades e conhecimentos são sólidos, mas há oportunidades para uma aplicação mais sistemática e consistente, especialmente no compartilhamento de suas experiências. Ações recomendadas: Fortaleça sua rotina de atualização e organize melhor o compartilhamento dos seus conhecimentos, buscando proativamente feedback para aprimorar suas práticas.",
    average:
      "Há desafios na aplicação regular das suas competências e na busca por atualização, o que impacta o compartilhamento de aprendizados. Ações recomendadas: Participe de cursos e seminários na sua área e estimule trocas de experiências com colegas para elevar sua prática profissional.",
    bad:
      "Sua pontuação indica dificuldades significativas em aplicar suas habilidades de forma consistente, com pouca iniciativa para atualização e compartilhamento. Ações recomendadas: Invista fortemente em autodesenvolvimento por meio de treinamentos, mentorias e leituras especializadas para construir uma base sólida e aplicá-la regularmente.",
  },
  "3. CONFIANÇA": {
    excellent:
      "Você demonstra ser altamente confiável, alinhando suas palavras e ações com transparência e integridade, o que se reflete em relacionamentos sólidos e no cumprimento consistente de seus compromissos. Ações recomendadas: Mantenha essa postura exemplar e continue buscando feedback para aperfeiçoar ainda mais sua integridade e consistência.",
    good:
      "Sua postura é geralmente íntegra e consistente, embora existam oportunidades para aumentar a transparência em situações desafiadoras. Ações recomendadas: Trabalhe para alinhar ainda mais suas ações com seu discurso, solicitando feedback de colegas e aprimorando sua comunicação nos momentos difíceis.",
    average:
      "Você enfrenta desafios para manter uma postura íntegra e consistente, o que impacta a percepção de sua confiabilidade. Ações recomendadas: Invista em estratégias para fortalecer sua comunicação e ética profissional, buscando novos hábitos que ajudem a alinhar seus compromissos com suas ações.",
    bad:
      "Sua pontuação sugere dificuldades significativas em demonstrar confiabilidade e integridade, prejudicando seus relacionamentos e parcerias. Ações recomendadas: Dedique-se a desenvolver a transparência e a consistência, participando de treinamentos em ética e integridade e solicitando feedback regular para ajustar seu comportamento.",
  },
  "4. COLABORAÇÃO": {
    excellent:
      "Você se destaca pela disposição em contribuir de forma espontânea e pelo engajamento ativo em iniciativas que agregam valor ao coletivo, fortalecendo parcerias e relações de trabalho. Ações recomendadas: Continue se envolvendo em atividades de grupo e incentivando a troca de conhecimentos, reforçando sua influência positiva no ambiente profissional.",
    good:
      "Sua colaboração é consistente, mas há momentos em que um engajamento mais proativo pode beneficiar ainda mais o coletivo. Ações recomendadas: Busque participar mais ativamente de projetos de equipe e ofereça apoio de forma mais desinteressada para ampliar sua rede de alianças.",
    average:
      "Você apresenta desafios em oferecer ajuda de forma espontânea e em engajar-se ativamente, o que pode limitar a formação de vínculos sólidos. Ações recomendadas: Participe de projetos colaborativos, pratique oferecer ajuda sem esperar retorno e solicite feedback sobre sua postura colaborativa.",
    bad:
      "Sua pontuação indica dificuldades significativas em colaborar sem esperar algo em troca, comprometendo o desenvolvimento de parcerias e a percepção de seu valor no grupo. Ações recomendadas: Invista em atividades de grupo, busque trocar sobre colaboração com outras pessoas e desenvolva uma mentalidade de contribuir primeiro para fortalecer sua rede.",
  },
  "5. VISIBILIDADE": {
    excellent:
      "Você promove suas conquistas e habilidades de forma estratégica e natural, utilizando eventos, redes sociais e outras ferramentas para ampliar sua presença e consolidar sua marca pessoal. Ações recomendadas: Continue ampliando sua visibilidade e explore novas oportunidades de autopromoção e networking para expandir sua influência.",
    good:
      "Sua capacidade de divulgação é boa, mas pode ser aprimorada com uma abordagem mais sistemática e regular, tanto em eventos quanto nas redes sociais. Ações recomendadas: Atualize seus perfis com maior frequência e planeje sua participação em eventos e publicações para fortalecer sua presença no mercado.",
    average:
      "Sua divulgação ocorre de forma intermitente, com uso esporádico das redes sociais e participação irregular em eventos, o que dificulta o reconhecimento de suas competências. Ações recomendadas: Invista em estratégias de autopromoção, atualize regularmente seus canais digitais e participe ativamente de oportunidades para compartilhar seus resultados.",
    bad:
      "Sua pontuação revela dificuldades em tornar seu trabalho conhecido, prejudicando o reconhecimento de suas competências e limitando oportunidades de crescimento. Ações recomendadas: Dedique-se a desenvolver sua marca pessoal, mantendo perfis profissionais atualizados, participando de eventos relevantes e buscando oportunidades para falar sobre seus projetos e conquistas.",
  },
};
...
new Chart(ctxRadar, {
 ...
 // Total Result
  ...
  sections.forEach((section, index) => {
    ...
    sectionScore.innerHTML = `${sectionScores[index]} de 15 pontos possíveis`;
