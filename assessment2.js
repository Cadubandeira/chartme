...
const sectionInterpretations = {
  "1. AGRADABILIDADE": {
    ...
    bad:
      "Necessário Investir Intensamente: Sua pontuação indica dificuldade significativa em demonstrar receptividade e estabelecer vínculos positivos, prejudicando seu networking. Ações recomendadas: Busque conteúdos, workshops e mentorias focadas em comunicação eficaz e relacionamento interpessoal, e esforce-se para interagir com pessoas fora do seu círculo habitual, adotando novos hábitos de vida. Para saber mais sobre a agradabilidade e o IMP (Índice de Magnetismo Pessoal), você pode acessar os materiais de aprofundamento gratuitos no site www.innernetworking.com.br. Além disso, caso seja do seu interesse, você pode obter uma versão detalhada do seu IMP e mesmo desenvolver o seu Desafio Perfeito para dar um salto evolutivo em seu nível de networking.",
  },
  "2. EXPERTISE": {
    excellent:
